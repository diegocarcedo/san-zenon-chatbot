...
## Roadmap (v2, no activo aún)

Conectores planeados para próximas versiones (todavía **no implementados**):

- INTA documentation connector
- AAPRESID documentation connector
- agro margins / market context connector
- weather/rainfall data source
- price reference source
- external technical knowledge base
